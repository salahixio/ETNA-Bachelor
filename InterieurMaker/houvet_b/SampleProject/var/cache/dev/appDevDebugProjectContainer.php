...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'planning.reservation' => 'getPlanning_ReservationService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ImFrontBundle', ($this->targetDirs[3].'/app/Resources/ImFrontBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ImFrontBundle', ($this->targetDirs[3].'/src/Im/FrontBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PlanningBundle', ($this->targetDirs[3].'/app/Resources/PlanningBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PlanningBundle', ($this->targetDirs[3].'/src/PlanningBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebRTCBundle', ($this->targetDirs[3].'/app/Resources/WebRTCBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebRTCBundle', ($this->targetDirs[3].'/src/WebRTCBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('V37c8rk5jX', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mU9ZMKpW2f', 0, 'e+kdr0LlMVuwDR9D4ombXg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('swKmZdtON0', 0, 'e+kdr0LlMVuwDR9D4ombXg', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7ZPs3tVYat', 0, 'e+kdr0LlMVuwDR9D4ombXg', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/PlanningBundle/Entity'), 1 => ($this->targetDirs[3].'/src/UserBundle/Entity'), 2 => ($this->targetDirs[3].'/src/WebRTCBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'PlanningBundle\\Entity');
        $c->addDriver($b, 'UserBundle\\Entity');
        $c->addDriver($b, 'WebRTCBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('PlanningBundle' => 'PlanningBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'WebRTCBundle' => 'WebRTCBundle\\Entity'));
    ...
    /**
     * Gets the 'planning.reservation' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PlanningBundle\Controller\ReservationController A PlanningBundle\Controller\ReservationController instance
     */
    protected function getPlanning_ReservationService()
    {
        return $this->services['planning.reservation'] = new \PlanningBundle\Controller\ReservationController();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/gestion_agent');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/subscribeAgent');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'ImFrontBundle', 1 => 'PlanningBundle', 2 => 'WebRTCBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PlanningBundle/Resources/views'), 'Planning');
        $instance->addPath(($this->targetDirs[3].'/src/Im/FrontBundle/Resources/views'), 'ImFront');
        $instance->addPath(($this->targetDirs[3].'/src/UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/WebRTCBundle/Resources/views'), 'WebRTC');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('314f734da77ccfec3e410de6ab08d54316850126');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_AGENT' => array(0 => 'ROLE_AGENT'), 'ROLE_USER' => array(0 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PlanningBundle' => 'PlanningBundle\\PlanningBundle',
                'ImFrontBundle' => 'Im\\FrontBundle\\ImFrontBundle',
                'UserBundle' => 'UserBundle\\UserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'WebRTCBundle' => 'WebRTCBundle\\WebRTCBundle',
            ...
            'secret' => '314f734da77ccfec3e410de6ab08d54316850126',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '314f734da77ccfec3e410de6ab08d54316850126',
