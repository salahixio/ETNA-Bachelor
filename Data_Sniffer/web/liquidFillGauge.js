...
function liquidFillGaugeDefaultSettings(){
    return {
	    ...
	    circleColor: "#8FCF3C", // The color of the outer circle.
	    ...
	    waveColor: "#8FCF3C", // The color of the fill wave.
	    ...
	    textColor: "#8FCF3C", // The color of the value text when the wave does not overlap it.
